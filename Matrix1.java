...
public class Matrix1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = findViewById((R.id.mat1Title));
        ...
        String [][]  matrix = {
                ...
                {"EMA","DREW","SEVEN","FOOTBALLS"},
                {"MATHEW","BOUGHT","EIGHT","BOTTLES"},
                {"ANDREW","HAS","NINE","BANANAS"}
        };
        matrixSize = 4;
        linesToPlay = new int [4];
        theFile = "mat1words.txt";
    ...
    public void playSound() throws InterruptedException {
        ...
        //    setWords(); ///clear colours for fresh run

            //calculate random pointers
             //clear colours for fresh run
 ...
 // pick random columns from matrix rows
   public void setupWords() {
      ...
      linesToPlay = new int[4];
        ...
        for (i=0;i<4;i++){ /// row
          index = rndNumber.nextInt(4);
                arrayIndex[i] = index;  // column
              linePointer = index*4 +i; // position of soundfile in list
    ...
    */
    ...
    public void goHelp (View view)
    {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Matrix1.this);
        builder.setTitle("HELP")
                .setMessage("This App plays from a Matrix of Words \n" +
                        ...
                        "You can add Background noise by pressing Nature or Babble\n" +
    ...
    public void goExit(View view)
    {
        ...
        Intent intent = new Intent(Matrix1.this, MainActivity.class);
